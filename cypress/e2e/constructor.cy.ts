...
describe('', function () {
  ...
  describe('create order', function() {
    ...
    it('click create order button', function() { //Вызывается клик по кнопке «Оформить заказ»
      cy.intercept('GET', 'api/auth/user', { fixture: 'user.json' }).as('getUser');
      // cy.get('[data-cy="user-name"]').contains('TEST');
        ...
        cy.get('[data-cy="login"]').should('contain.text', 'TEST');
